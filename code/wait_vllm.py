...
def inference(args, data_queue: Queue, result_save_path, process_id):
    ...
    while not data_queue.empty():
        ...
        responses = []
        for question in inference_data["user_prompt"]:
            ...
            responses.append(t.text for t in output[0].outputs)
...
def make_parser():
    ...
    parser.add_argument("--dataset",  default="./result/wait_outputs/aime24/wait_1_vllm", type=str, help="inference dataset name")
...
if __name__ == "__main__":
    ...
    # Load input data
    input_data = json.loads(open(f'{args.dataset}.json', 'r').read())
